...
public class AbstractionMain {
	public static void main(String[] args) {
		...
		StudentOperations studentOperations = new StudentBuilder();
		BranchOperations branchOperations = new BranchBuilder();
		...
		branchOperations.addBranch(br1);
		branchOperations.addBranch(br2);
		branchOperations.addBranch(br3);
		branchOperations.addBranch(br4);
		...
		studentOperations.addStudent(std1);
		studentOperations.addStudent(std2);
		studentOperations.addStudent(std3);
		studentOperations.addStudent(std4);

		studentOperations.printAllStudents();

		System.out.println(studentOperations.removeStudent(std4.getId()));

		studentOperations.replaceStudent(std2.getId(), std3);

		System.out.println("Update Student Details : " + studentOperations.updateStudentBranch(std3.getId(), br1));

		System.out.println(studentOperations.getStudentByGender("female"));
