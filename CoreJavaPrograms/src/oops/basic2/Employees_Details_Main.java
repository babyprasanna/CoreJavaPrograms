 ...
 * Employee_Project , Designation Details and Project to check Project Status
 * Details
 * 
 * 
 * @author prasa
...
public class Employees_Details_Main {
	public static void main(String[] args) {
		...
		designation.resigned_teams = 4;
		designation.resigned_count = 11;
		designation.last_dates = "11/22/2020";
		designation.no_of_approved_resignations = true;

		System.out.println(designation);

		Project projectstatus = new Project();

		projectstatus.project_name = "The code Honors";
		projectstatus.finish_status = true;
		projectstatus.no_of_days_complete = 10;
		projectstatus.profits = true;
